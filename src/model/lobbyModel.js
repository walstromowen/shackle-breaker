...
import { Dagger, ShortSword, BlacksmithHammer, ArcaneStaff, LinenShirt, LinenPants, PineWood, Handaxe, LeatherHelmet, LeatherHood, Shortbow, HealthPotion, PoisonedKnife} from "./misc/items.js";
    ...
    updateKeepsake(){
        ...
        switch(keepsake){
            case 'hunters-tools':
                ...
                break;
            case 'bag-of-potions':
                this.props.setInventory([new HealthPotion(), new PoisonedKnife(), new PineWood()]);
                break;
