...
export default class Player{
    constructor(characterCreationArray, map){
        ...
        this.maxStamina = characterCreationArray[5][0];
        this.currentStamina = this.maxStamina;
        this.maxMagic = characterCreationArray[5][0];
        this.currentMagic = this.maxMagic;
        this.baseBluntAttack = characterCreationArray[5][0];
        this.currentBluntAttack = this.baseBluntAttack;
        this.basePierceAttack = characterCreationArray[5][1];
        this.currentPierceAttack = this.basePierceAttack;
        this.baseArcaneAttack = characterCreationArray[5][2];
        this.currentArcaneAttack = this.baseArcaneAttack;
        this.baseElementalAttack = characterCreationArray[5][3];
        this.currentElementalAttack = this.baseElementalAttack;
        this.baseBluntDefense = characterCreationArray[5][4];
        this.currentBluntDefense = this.baseBluntDefense;
        this.basePierceDefense = characterCreationArray[5][5];
        this.currentPierceDefense = this.basePierceDefense;
        this.baseArcaneDefense = characterCreationArray[5][6];
        this.currentArcaneDefense = this.baseArcaneDefense;
        this.baseElementalDefense = characterCreationArray[5][7];
        this.currentElementalDefense = this.baseElementalDefense;
        this.baseSpeed = characterCreationArray[5][8];
