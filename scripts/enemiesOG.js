...
export class Bat extends Enemy{
    constructor(playerLevel){
        ...
        this.baseElementalAttack = 2 + playerLevel;
        this.currentElementalAttack = this.baseElementalAttack;
        this.baseBluntDefense = 0 + playerLevel;
        this.currentBluntDefense = this.baseBluntDefense;
        this.basePierceDefense = 0 + playerLevel;
        this.currentPierceDefense = this.basePierceDefense;
        this.baseArcaneDefense = 0 + playerLevel;
        this.currentArcaneDefense = this.baseArcaneDefense;
        this.baseElementalDefense = 0 + playerLevel;
        this.currentElementalDefense = this.baseElementalDefense;
        this.baseSpeed = 2;
        this.currentSpeed = this.baseSpeed;
...
export class Royalmage extends Enemy{
    constructor(playerLevel){
        ...
        this.baseElementalAttack = 2 + playerLevel;
        this.currentElementalAttack = this.baseElementalAttack;
        this.baseBluntDefense = 1 + playerLevel;
        this.currentBluntDefense = this.baseBluntDefense;
        this.basePierceDefense = 1 + playerLevel;
        this.currentPierceDefense = this.basePierceDefense;
        this.baseArcaneDefense = 3 + playerLevel;
        this.currentArcaneDefense = this.baseArcaneDefense;
        this.baseElementalDefense = 2 + playerLevel;
        this.currentElementalDefense = this.baseElementalDefense;
        this.baseSpeed = 1;
...
export class Groveguardian extends Enemy{
    constructor(playerLevel){
        ...
        this.baseElementalAttack = 2 + playerLevel;
        this.currentElementalAttack = this.baseElementalAttack;
        this.baseBluntDefense = 3 + playerLevel;
        this.currentBluntDefense = this.baseBluntDefense;
        this.basePierceDefense = 1 + playerLevel;
        this.currentPierceDefense = this.basePierceDefense;
        this.baseArcaneDefense = 2 + playerLevel;
        this.currentArcaneDefense = this.baseArcaneDefense;
        this.baseElementalDefense = 1 + playerLevel;
        this.currentElementalDefense = this.baseElementalDefense;
        this.baseSpeed = 1;
        this.currentSpeed = this.baseSpeed;
