...
export class Entity{
    constructor(config, isRehydrate = false){
        ...
        this.appearance = config.appearance || './assets/media/entities/knight-1.jpg';
...
export class Traveler extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            appearance: './assets/media/entities/traveler.jpg',
...
export class Dog extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: './assets/media/entities/dog.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class Hawk extends Entity{
    constructor(config, isRehydrate = false){
        super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: './assets/media/entities/hawk.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class Tiger extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance ||'./assets/media/entities/snowy-tiger.jpg',
            vigor: config.vigor || 5,
...
export class Madman extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/cursed-villager-1.jpg',
            vigor: config.vigor || 5,
...
export class MadBandit extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/mad-bandit.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 7,
            intelligence: config.intelligence || 3,
...
export class MadMage extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/mad-mage.jpg',
            vigor: config.vigor || 5,
...
export class AlterianWarrior extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/alterian-warrior.jpg',
            vigor: config.vigor || 5,
...
export class Wolf extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/wolf.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class WoodWhisperer extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/wood-whisperer.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 6,
            dexterity: config.dexterity || 3,
            intelligence: config.intelligence || 4,
...
export class MurderMutt extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/murder-mutt.png',
...
export class GroveGuardian extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/grove-guardian.jpg',
            vigor: config.vigor || 8,
            strength: config.strength || 6,
            dexterity: config.dexterity || 3,
            intelligence: config.intelligence || 3,
...
export class Skeleton extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/skeleton.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class ArmoredSkeleton extends Skeleton{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/armored-skeleton.jpg',
            equipment: config.equipment || {
                mainHand: new ShortSword({level: 1}),
                offhand: new Buckler({level: 1}),
                head: '',
...
export class FloatingSkull extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/floating-skull.jpg',
...
export class SkeletonCultist extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.skeleton || './assets/media/entities/skeleton-light-mage.jpg',
...
export class SkeletonColossus extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/skeleton-colossus.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class Spider extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/spider.jpg',
            vigor: config.vigor || 4,
            strength: config.strength || 4,
            dexterity: config.dexterity || 6,
            intelligence: config.intelligence || 5,
...
export class InferiorLord extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/inferior-lord-2.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class SandStalker extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/sand-stalker.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class DryShark extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/dry-shark.jpg',
...
export class DryEel extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/dry-eel.jpg',
            vigor: config.vigor || 3,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class DryKraken extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/dry-kraken.jpg',
...
export class DryKrakenTentacle extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/dry-kraken-tentacle.jpg',
            vigor: config.vigor || 8,
            strength: config.strength || 7,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class TheSandShade extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/the-sand-shade.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class PanzerianKnight extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/panzerian-knight.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 7,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 4,
...
export class MadEngineer extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/mad-engineer.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 6,
            dexterity: config.dexterity || 4,
...
export class IcePhoenix extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/ice-phoenix.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 4,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 3,
...
export class Panzerkamfer extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/panzerkamfer.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 6,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 6,
...
export class Sterben extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/sterben.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class SterbensBeast extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/sterbens-beast.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
...
export class ShackledHunter extends Entity{
    constructor(config, isRehydrate = false){
        super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/shackled-hunter.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 7,
            dexterity: config.dexterity || 7,
            intelligence: config.intelligence || 3,
...
export class ShackledSpirit extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/shackled-spirit.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 3,
            dexterity: config.dexterity || 3,
            intelligence: config.intelligence || 7,
...
export class TerrorBear extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/terror-bear.jpg',
            vigor: config.vigor || 6,
            strength: config.strength || 7,
            dexterity: config.dexterity || 6,
            intelligence: config.intelligence || 3,
...
export class Nightblade extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: './assets/media/entities/nightblade.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 7,
            intelligence: config.intelligence || 7,
...
export class EmperorDolos extends Entity{
    constructor(config, isRehydrate = false){
         super({
            ...
            level: config.level || 1,
            difficulty: config.difficulty || 'normal',
            appearance: config.appearance || './assets/media/entities/emperor-dolos.jpg',
            vigor: config.vigor || 5,
            strength: config.strength || 5,
            dexterity: config.dexterity || 5,
            intelligence: config.intelligence || 5,
