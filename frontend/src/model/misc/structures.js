...
import { BerryBush, Boulder, Entrance, Exit, PineTree, DeadTree, Wall, DeadBush } from "./mapObjects.js";
       ...
       /*
        if(tileSet[desiredY + y][desiredX + x].mapObject){
            if(tileSet[desiredY + y][desiredX + x].mapObject.name == 'entrance'){
                console.log('error! replacing entrance')
            }
        }
 ...
 export class ForestEntranceRoom extends Structure{
    generateStructureMap(){
        ...
        structureMap[Math.floor(height/2)][Math.floor(width/2)] = new Tile({mapObject: new Entrance({}), priority: 5,})
        return structureMap;
    }
 }
 export class ForestExitRoom extends Structure{
    generateStructureMap(){
        ...
        structureMap[Math.floor(height/2)][Math.floor(width/2)] = new Tile({mapObject: new Exit({imageCoordinates: [1,2], imageFrameSize:[1,1]}), priority: 4,})
...
export class CaveEntranceRoom extends Structure{
 ...
 export class CaveExitRoom extends Structure{
    generateStructureMap(){
        ...
        structureMap[Math.floor(height/2)][Math.floor(width/2)] = new Tile({mapObject: new Exit({}), priority: 4,})
...
export class DesertEntranceRoom extends Structure{
 ...
 export class DesertExitRoom extends Structure{
    generateStructureMap(){
        ...
        structureMap[Math.floor(height/2)][Math.floor(width/2)] = new Tile({mapObject: new Exit({imageCoordinates: [0,2], imageFrameSize:[1,1]}), priority: 4,})
...
export class DesertRoom2 extends Structure{
    generateStructureMap(){
        let structureMap = []
        let width = 5 + Math.floor(Math.random()*5)
        let height = 5 + Math.floor(Math.random()*5)
...
export class WastelandEntranceRoom extends Structure{
 ...
 export class WastelandExitRoom extends Structure{
    generateStructureMap(){
        ...
        structureMap[Math.floor(height/2)][Math.floor(width/2)] = new Tile({mapObject: new Exit({imageCoordinates: [1,7], imageFrameSize:[1,1]}), priority: 4,})
