                ...
                new Decision({
                    ...
                    successfulOutcomes: [
                        new Result({
                            ...
                            createBattleKey: 'emperorDolos',
                            createNextStageKey: 'theKingdomsFate',
                            messageKey: 'theArtifactShackleBreaker',
                            weight: 1,
                        }),
                    ],
                }),
...
export class TheKingdomsFate extends Stage {
  constructor(config) {
    super({
      ...
      imageSrc: './assets/media/encounters/the-artifact.jpg',
      messageKey: 'theKingdomsFateIntro',
      decisionArray: config.decisionArray || [
        new Decision({
          ...
          successfulOutcomes: [
            new Result({
              result: 'nextStage',
              createNextStageKey: 'aHeroPrevails',
              messageKey: 'theKingdomsFateDestroyArtifactMessage',
              weight: 1,
            }),
          ],
        }),
        new Decision({
          ...
          successfulOutcomes: [
            new Result({
              result: 'nextStage',
              createNextStageKey: 'aPowerfulChoice',
              messageKey: 'theKingdomsFateClaimArtifactMessage',
              weight: 1,
            }),
          ],
        }),
...
export class AHeroPrevails extends Stage {
  constructor(config) {
    super({
      ...
      imageSrc: './assets/media/encounters/the-artifact.jpg',
      messageKey: 'aHeroPrevailsIntro',
      decisionArray: config.decisionArray || [
        new Decision({
          description: 'Leave.',
          messageKey: 'aHeroPrevailsLeave',
          successfulOutcomes: [
            new Result({
              result: 'complete',
              xpReward: 1000,
...
export class APowerfulChoice extends Stage {
  constructor(config) {
    super({
      ...
      imageSrc: './assets/media/encounters/the-artifact.jpg',
      messageKey: 'aPowerfulChoiceIntro',
      decisionArray: config.decisionArray || [
        new Decision({
        ...
        new Decision({
          ...
          successfulOutcomes: [
            new Result({
              result: 'nextStage',
              onActivateKey: 'aPowerfulChoiceUseArtifact',
              createNextStageKey: 'theCycleContinues',
              messageKey: 'aPowerfulChoiceUseArtifactMessage',
              xpReward: 10,
              weight: 1,
            }),
          ],
...
export class TheCycleContinues extends Stage {
  constructor(config) {
    super({
      ...
      imageSrc: './assets/media/encounters/the-artifact.jpg',
      messageKey: 'theCycleContinuesIntro',
      decisionArray: config.decisionArray || [
        new Decision({
          description: 'Leave.',
          messageKey: 'theCycleContinuesLeaveMessage',
          successfulOutcomes: [
            new Result({
              result: 'complete',
              xpReward: 10,
