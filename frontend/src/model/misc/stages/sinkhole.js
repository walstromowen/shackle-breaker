        ...
        super({
            ...
            decisionArray: config.decisionArray || [
                new Decision({
                    ...
                    successThreshold: 12,
                    roll: true,
                    messageKey: 'sinkholeRunAttempt',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'sinkholeEscapeSuccess',
                            xpReward: 5,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        new Result({
                            result: 'nextStage',
                            createNextStageKey: 'gaintTentacle',
                            weight: 2,
                        }),
                        new Result({
                            result: 'battle',
                            ...
                            createBattleKey: 'drySharks',
                            messageKey: 'sinkholeSharkEmerges',
                            weight: 1,
                        })
                    ],
                }),
                new Decision({
                    ...
                    successThreshold: 12,
                    roll: true,
                    messageKey: 'sinkholeGrabRock',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'sinkholeGrabSuccess',
                            xpReward: 5,
                            weight: 1,
                        }),
                    ],
        ...
        super({
            ...
            decisionArray: config.decisionArray || [
                new Decision({
                    ...
                    successThreshold: 12,
                    roll: true,
                    messageKey: 'gaintTentacleRunAttempt',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'gaintTentacleEscapeSuccess',
                            xpReward: 5,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        new Result({
                            result: 'nextStage',
                            createNextStageKey: 'desertHorror',
                            weight: 1,
                        })
                    ],
                }),
                new Decision({
                    ...
                    successThreshold: 16,
                    roll: true,
                    messageKey: 'gaintTentacleSwingAttempt',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'gaintTentacleSwingSuccess',
                            xpReward: 5,
                            weight: 1,
                        }),
                    ],
...
export class DesertHorror extends Stage {
    constructor(config) {
        super({
            ...
            messageKey: 'desertHorrorIntro',
            decisionArray: config.decisionArray || [
                new Decision({
                    description: 'Prepare to fight.',
                    messageKey: 'desertHorrorPrepareToFight',
                    successfulOutcomes: [
                        new Result({
                            result: 'battle',
                            createBattleKey: 'dryKraken',
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    description: 'Swing at the tentacles. [STR]',
                    attributes: ['strength'],
                    successThreshold: 14,
                    roll: true,
                    messageKey: 'desertHorrorSwingTentacles',
                    successfulOutcomes: [
                        new Result({
                            result: 'battle',
                            createBattleKey: 'desertHorrorSwingTentaclesSuccess',
                            messageKey: 'desertHorrorSwingTentaclesSuccess',
                            xpReward: 6,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        new Result({
                            result: 'battle',
                            createBattleKey: 'dryKraken',
                            messageKey: 'desertHorrorSwingTentaclesFail',
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    description: 'Throw a dagger at its eye. [DEX]',
                    attributes: ['dexterity'],
                    successThreshold: 16,
                    roll: true,
                    messageKey: 'desertHorrorThrowAtEye',
                    successfulOutcomes: [
                        new Result({
                            result: 'battle',
                            createBattleKey: 'desertHorrorThrowAtEyeSuccess',
                            messageKey: 'desertHorrorThrowAtEyeSuccess',
                            xpReward: 6,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        new Result({
                            result: 'battle',
                            createBattleKey: 'dryKraken',
                            messageKey: 'desertHorrorThrowAtEyeFail',
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    description: 'Jump into its mouth. [STR]',
                    attributes: ['strength'],
                    successThreshold: 18,
                    roll: true,
                    messageKey: 'desertHorrorJumpInMouth',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            createLootKey: 'randomBiomeItem2',
                            messageKey: 'desertHorrorJumpInMouthSuccess',
                            xpReward: 10,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        new Result({
                            result: 'battle',
                            createBattleKey: 'dryKraken',
                            messageKey: 'desertHorrorJumpInMouthFail',
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    ...
                    successThreshold: 17,
                    roll: true,
                    messageKey: 'desertHorrorRun',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'desertHorrorRunSuccess',
                            xpReward: 8,
                            weight: 1,
                        }),
                    ],
