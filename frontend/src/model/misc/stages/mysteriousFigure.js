...
export class MysteriousFigure extends Stage {
    constructor(config) {
        super({
            ...
            messageKey: 'mysteriousFigureIntro',
            decisionArray: config.decisionArray || [
                new Decision({
                    description: 'Approach the figure',
                    messageKey: 'mysteriousFigureApproachMsg',
                    successfulOutcomes: [
                        new Result({
                            result: 'nextStage',
                            createNextStageKey: 'mysteriousFigureApproach',
                            weight: 1,
                        }),
                    ],
                }),
...
export class SuspiciousMan extends Stage {
    constructor(config) {
        super({
            ...
            messageKey: 'suspiciousManIntro',
            decisionArray: [
                new Decision({
                    option: 'A',
                    description: "Buy the potion. [50g]",
                    goldCost: 50,
                    messageKey: 'suspiciousManBuyPotion',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            createLootKey: 'suspiciousManPotionLoot',
                            messageKey: 'suspiciousManBuyPotionSuccess',
                            xpReward: 5,
                            weight: 1,
                        }),
                    ],
                ...
                new Decision({
                    option: 'B',
                    description: "Persuade the Suspicious Man to buy the potion for half price. [25g].",
                    goldCost: 25,
                    ...
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            createLootKey: 'suspiciousManPotionLoot',
                            messageKey: 'suspiciousManPersuadeManSuccess',
                            xpReward: 10,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'suspiciousManPersuadeManFail',
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    ...
                    successThreshold: 16,
                    roll: true,
                    messageKey: 'suspiciousManPickpocketAttempt',
                    successfulOutcomes: [
                        new Result({
                            result: 'retry',
                    ...
                    negativeOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'suspiciousManPickpocketFail',
                            onActivateKey: 'increaseCorruption5Percent',
                            weight: 1,
                        }),
                    ],
...
export class ShadowyWarrior extends Stage {
    constructor(config) {
        super({
            ...
            messageKey: 'shadowyWarriorIntro',
            decisionArray: [
                new Decision({
                    option: 'A',
                    ...
                    successThreshold: 18,
                    roll: true,
                    messageKey: 'shadowyWarriorCommunicateAttempt',
                    successfulOutcomes: [
                        new Result({
                            result: 'recruit',
                            createRecruitKey: 'nightblade',
                            messageKey: 'shadowyWarriorCommunicateRespect',
                            xpReward: 15,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'shadowyWarriorCommunicateDisappear',
                            weight: 1,
                        }),
                        new Result({
                            result: 'battle',
                            musicSrc: "./assets/audio/musicTracks/battle-sword-139313.mp3",
                            createBattleKey: 'nightblade',
                            messageKey: 'shadowyWarriorCommunicateBattle',
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    ...
                    messageKey: 'shadowyWarriorDuelChallenge',
                    successfulOutcomes: [
                        new Result({
                            result: 'battle',
                            musicSrc: "./assets/audio/musicTracks/battle-sword-139313.mp3",
                            createBattleKey: 'duelNightblade',
                            createNextStageKey: 'defeatedNightblade',
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    ...
                    messageKey: 'shadowyWarriorBackAway',
                    successfulOutcomes: [
                        new Result({ result: 'complete', weight: 1 }),
                    ],
                }),
...
export class DefeatedNightblade extends Stage {
    constructor(config) {
        super({
            ...
            imageSrc: './assets/media/entities/nightblade.jpg',
            messageKey: 'defeatedNightbladeIntro',
            decisionArray: [
                new Decision({
                    description: "Execute the warrior.",
                    messageKey: 'defeatedNightbladeExecuteWarrior',
                    successfulOutcomes: [
                        new Result({
                            result: 'complete',
                            createLootKey: 'defeatedNightbladeLoot',
                            onActivateKey: 'increaseCorruption10Percent',
                            xpReward: 10,
                            weight: 1,
                        }),
                    ],
                ...
                new Decision({
                    ...
                    successThreshold: 5,
                    roll: true,
                    messageKey: 'defeatedNightbladeSpareWarrior',
                    successfulOutcomes: [
                        new Result({
                            result: 'recruit',
                            createRecruitKey: 'nightblade',
                    ...
                    negativeOutcomes: [
                        new Result({
                            result: 'complete',
                            messageKey: 'defeatedNightbladeSpareWarriorFail',
                            weight: 1,
                        }),
                    ],
                }),
