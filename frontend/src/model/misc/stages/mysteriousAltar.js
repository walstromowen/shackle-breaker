...
export class MysteriousAltar extends Stage {
  constructor(config) {
    super({
      ...
      messageKey: 'mysteriousAltarIntro',
      decisionArray: config.decisionArray || [
        new Decision({
          ...
          successThreshold: 12,
          roll: true,
          messageKey: 'mysteriousAltarApproach',
          successfulOutcomes: [
            new Result({
              result: 'nextStage',
              createNextStageKey: 'atTheMysteriousAltar',
              xpReward: 5,
              weight: 1,
            }),
          ],
          negativeOutcomes: [
            new Result({
              ...
              createBattleKey: 'randomSkeletonBattle',
              createNextStageKey: 'atTheMysteriousAltar',
              messageKey: 'altarSkeletonsAttack',
              weight: 1,
            }),
            new Result({
              result: 'nextStage',
...
export class AtTheMysteriousAltar extends Stage {
  constructor(config) {
    super({
      name: 'Mysterious Altar',
      imageSrc: './assets/media/encounters/at-the-altar.jpg',
      messageKey: 'altarSkullIntro',
      decisionArray: config.decisionArray || [
        new Decision({
          ...
          successfulOutcomes: [
            new Result({
              result: 'complete',
              onActivateKey: 'shortRest',
              messageKey: 'altarBlueGlowStrength',
              xpReward: 10,
              weight: 1,
            }),
            new Result({
              result: 'complete',
              createLootKey: 'randomBiomeItem3',
              messageKey: 'altarGreenGlowLoot',
              xpReward: 10,
              weight: 1,
            }),
          ],
          negativeOutcomes: [
            new Result({
              ...
              messageKey: 'altarRedGlowAttack',
              weight: 1,
            }),
            new Result({
              result: 'nextStage',
              createNextStageKey: 'aSkeletalAbomination',
              messageKey: 'altarBoneSwirlWarning',
              weight: 2,
            }),
          ],
        }),
        new Decision({
          description: 'Back up.',
          messageKey: 'altarBackUpMessage',
          successfulOutcomes: [
            new Result({
              result: 'nextStage',
              createNextStageKey: 'aMysteriousAltar',
              weight: 1,
            }),
          ],
        }),
...
export class ASkeletalAbomination extends Stage {
  constructor(config) {
    super({
      ...
      messageKey: 'skeletalAbominationIntro',
      decisionArray: config.decisionArray || [
        new Decision({
          description: 'Attack',
          successfulOutcomes: [
            new Result({
              result: 'battle',
              createBattleKey: 'skeletalAbominationColossusBattle',
              messageKey: 'skeletalAbominationAttackMsg',
              weight: 1,
            }),
          ],
        }),
        new Decision({
          ...
          negativeOutcomes: [
            new Result({
              result: 'battle',
              createBattleKey: 'skeletalAbominationColossusBattle',
              messageKey: 'skeletalAbominationEscapeFail',
              weight: 1,
            }),
          ],
        }),
