    ...
    constructor(config) {
        super({
            ...
            decisionArray: config.decisionArray || [
                ...
                new Decision({
                    option: "C",
                    description: "Cast a spell. [INT]",
                    attributes: ["intelligence"],
                    successThreshold: 12,
                    roll: true,
                    messageKey: "treasureChestCastSpellAttempt",
                    successfulOutcomes: [
                        new Result({
                            result: "complete",
                            createLootKey: "randomBiomeItem2",
                            messageKey: "treasureChestCastSpellSuccess",
                            xpReward: 5,
                            weight: 1,
                        }),
                    ],
                    negativeOutcomes: [
                        ...
                        new Result({
                            ...
                            messageKey: "treasureChestCastSpellFail",
                            weight: 1,
                        }),
                        new Result({
                            result: "battle",
                            musicSrc: "./assets/audio/musicTracks/battle-of-the-dragons-8037.mp3",
                            createBattleKey: "treasureChestCastSpellSummonEvil",
                            createNextStageKey: "self",
                            messageKey: "treasureChestCastSpellSummonEvil",
                            weight: 1,
                        }),
                    ],
                }),
                new Decision({
                    option: "D",
                    description: "Search for the key. [ATN]",
