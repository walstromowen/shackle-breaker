...
export class Ability{
    ...
    prepareAbilitiy(attacker, targets){
        let resolveObject = {evade: false, switchCombatant: false, retreat: false, rest: false, polymorph: false, immune: false}
        ...
        if(this.polymorph !== null){
            resolveObject.polymorph = this.polymorph;
        }
    ...
    toSaveObject(){
        return {
            ...
            criticalChanceModifier: this.criticalChanceModifier,
            range: this.range,
            ...
            randomTargeting: this.randomTargeting,
            attackerAnimation: this.attackerAnimation,
            targetAnimation: this.targetAnimation,
            abilityAnimation: this.abilityAnimation,
            abilityAnimationImage: this.abilityAnimationImage,
            abilityAnimationDuration: this.abilityAnimationDuration,

            soundEffectSrc: this.soundEffectSrc,

            sequenceType: this.sequenceType,
            consumable: this.consumable ? this.consumable.toSaveObject?.() : '',
            message: this.message,
            duelWeilded: this.duelWeilded,
            polymorph: this.polymorph ? this.polymorph.toSaveObject?.() : null,
        };
    }
    static fromSaveObject(abilityData, abilityRegistry){
        let ability = abilityRegistry[abilityData.type](abilityData);
        return ability;
    }
}
...
export class SwitchCombatant extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'switch combatant',
            iconSrc: 'none',
...
export class Slash extends Ability{
    constructor(config){
        super({
            name: config.name || 'slash',
            type: config.name || 'slash',
...
export class ShootFlamingArrow extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'shoot flaming arrow',
...
export class MagicMissile extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'magic missile',
...
export class LightningBolt extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'lightning bolt',
...
export class Shapeshift extends Ability{
    ...
    activate(attacker, target){
        this.polymorph = Math.floor(Math.random()*3)
        switch(this.polymorph){
            case 0:
                this.polymorph = new Hawk({level: target.level});
            break;
            case 1:
                this.polymorph = new Dog({level: target.level});
            break;
            case 2:
                this.polymorph = new Tiger({level: target.level});
            break;
        }
        this.polymorph.nextAbility = target.nextAbility;
        let originalForm = {
            animation: 'twister',
        ...
        this.polymorph.nextForm = originalForm;
        this.polymorph.playNextFormMessage = ()=>{return `${target.name} returns to normal form.`;}//not adding the function
        this.polymorph.createNextForm = (difficulty)=>{return originalForm.entity}
        this.inflictStatus(new Polymorphed({holder: this.polymorph}), this.polymorph, this.polymorph);
    }
    updateMessage(attacker, target){
         this.message = `${target.name} transforms into a ${this.polymorph.name}.`;
    }
}
...
export class CallOfSterben extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'call of sterben',
    ...
    activate(attacker, target){
        this.polymorph = new SterbensBeast({level: target.level});
...
export class ChannelMagic extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'channel magic',
...
export class CastShadow extends Ability{
    ...
    activate(attacker, target){
        ...
        this.polymorph.nextForm = originalForm;
        this.polymorph.playNextFormMessage = ()=>{return `${target.name}'s shadow disipates.`;}//not adding the function
        this.polymorph.createNextForm = (difficulty)=>{return originalForm.entity}
        this.inflictStatus(new Polymorphed({holder: this.polymorph}), this.polymorph, this.polymorph);
    }
    updateMessage(attacker, target){
...
export class ExposeWeakness extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'expose weakness',
...
export class ThrowPosionedKnife extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'throw posioned knife',
...
export class SetBearTrap extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'set bear trap',
...
export class ThrowSmokeBomb extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'throw smoke bomb',
...
export class DrinkHealthPotion extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'drink health potion',
...
export class DrinkStaminaPotion extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'drink stamina potion',
...
export class DrinkMagicPotion extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'drink magic potion',
...
export class UseAloeRemedy extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'use aloe remedy',
...
export class UseParalysisTonic extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'use paralysis tonic',
...
export class DrinkKurtussBrewOfMadness extends Ability{
    constructor(config){
        super({
            ...
            type: config.type || 'drink kurtuss brew of madness',
