...
export class StatusEffect{
    ...
    toSaveObject() {
        return {
            ...
            holder: null,               //to be reconnected during load
            maxCharges: this.maxCharges,
            currentCharges: this.currentCharges,
            stackable: this.stackable,
            removeOnBattleEnd: this.removeOnBattleEnd,
    ...
    static fromSaveObject(statusData, statusEffectRegistry) {
        let status = statusEffectRegistry[statusData.name](statusData)
        return status
    } 
}
...
export class Poison extends StatusEffect{
    constructor(config){
        ...
        this.severityModifier = 0.08;
    }
    onEndTurn(){
        return this.activateHelpper(
            ()=>{
                let damage = this.checkDamage(this.holder, this.holder.maxHP * this.severityModifier, 'health');
                this.holder.currentHP = this.holder.currentHP - damage;
                this.severityModifier += 0.02;
    ...
    toSaveObject(){
        ...
        saveObject.severityModifier = this.severityModifier;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.severityModifier = statusData.severityModifier;
    }
}
...
export class Bleed extends StatusEffect{
    constructor(config){
        ...
        this.severityModifier = 0.12;
    }
    onEndTurn(){
        return this.activateHelpper(
            ()=>{
                let staminaDamage = Math.floor(this.holder.maxStamina * this.severityModifier);
                let healthDamage = 0;
...
export class Bind extends StatusEffect{
    ...
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.escapethreshold = statusData.escapethreshold;
    }
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.escapethreshold = this.escapethreshold;
        return saveObject;
    }
}
...
export class Cursed extends StatusEffect{
    ...
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.inflicter = statusData.inflicter;
    }
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.inflicter = this.inflicter;
        return saveObject;
    }
...
export class Polymorphed extends StatusEffect{
    constructor(config){//bassically just kills target after certain amount of turns to change back to original form
        super({
            name:'polymorphed',
            holder: config.holder,
...
export class PhysicalAttackBuff extends StatusEffect{
    ...
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.currentBluntAttackBuff = this.currentBluntAttackBuff;
        saveObject.currentPierceAttackBuff = this.currentPierceAttackBuff;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.currentLevel = statusData.currentLevel;
        this.currentBluntAttackBuff = currentBluntAttackBuff.currentLevel;
        this.currentPierceAttackBuff = currentBluntAttackBuff.currentLevel;
    }
}
export class PhysicalAttackDebuff extends StatusEffect{
    ...
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.currentBluntAttackDebuff = this.currentBluntAttackDebuff;
        saveObject.currentPierceAttackDebuff = this.currentPierceAttackDebuff;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.currentLevel = statusData.currentLevel;
        this.currentBluntAttackDebuff = currentBluntAttackDebuff.currentLevel;
        this.currentPierceAttackDebuff = currentPierceAttackDebuff.currentLevel;
    }
}
export class MagicalAttackBuff extends StatusEffect{
    ...
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.currentArcaneAttackBuff = this.currentArcaneAttackBuff;
        saveObject.currentElementalAttackBuff = this.currentElementalAttackBuff;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.currentLevel = statusData.currentLevel;
        this.currentArcaneAttackBuff = currentArcaneAttackBuff.currentLevel;
        this.currentElementalAttackBuff = currentElementalAttackBuff.currentLevel;
    }
}
export class MagicalAttackDebuff extends StatusEffect{
    ...
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.currentArcaneAttackDebuff = this.currentArcaneAttackDebuff;
        saveObject.currentElementalAttackDebuff = this.currentElementalAttackDebuff;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.currentLevel = statusData.currentLevel;
        this.currentArcaneAttackDebuff = currentArcaneAttackDebuff.currentLevel;
        this.currentElementalAttackDebuff = currentElementalAttackDebuff.currentLevel;
    }
}
export class PhysicalDefenseBuff extends StatusEffect{
    ...
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.currentBluntDefenseBuff = this.currentBluntDefenseBuff;
        saveObject.currentPierceDefenseBuff = this.currentPierceDefenseBuff;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.currentLevel = statusData.currentLevel;
        this.currentBluntDefenseBuff = currentBluntDefenseBuff.currentLevel;
        this.currentPierceDefenseBuff = currentPierceDefenseBuff.currentLevel;
    }
}
export class PhysicalDefenseDebuff extends StatusEffect{
    ...
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.currentBluntDefenseDebuff = this.currentBluntDefenseDebuff;
        saveObject.currentPierceDefenseDebuff = this.currentPierceDefenseDebuff;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
        this.currentLevel = statusData.currentLevel;
        this.currentBluntDefenseDebuff = currentBluntDefenseDebuff.currentLevel;
        this.currentPierceDefenseDebuff = currentPierceDefenseDebuff.currentLevel;
    }
}
export class EvasionBuff extends StatusEffect{
    ...
    toSaveObject(){
        let saveObject = super.toSaveObject();
        saveObject.currentEvasionBuff = this.currentEvasionBuff;
        return saveObject;
    }
    fromSaveObject(statusData){
        super.fromSaveObject(statusData);
