...
getAvailableTargets(attacker){
    ...
    getAvailableConsumableAbilities(){
        ...
        for(let i = 0; i < currentInventory.length; i++){
            if(currentInventory[i].itemSubset == 'consumable' && currentInventory[i].inProgress == false && currentInventory[i].useSituations.includes('battle')){
    ...
    getConsumables(){
        ...
        let currentInventory = this.props.getInventory();
        for(let i = 0; i < currentInventory.length; i++){
            if(currentInventory[i].itemSubset == 'consumable'){
